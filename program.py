...
print("WELCOME TO SWIFT CAB SERVICE. WE HOPE TO PROVIDE YOU WITH THE BEST EXPERIENCE POSSIBLE.")               #INTRO
...
while True:
    if option==1:                                       #USER REGISTRATION
        ...
        print('''Lyft was started in 2012 with the ambition of making every ride the best ever for the consumer.\n
