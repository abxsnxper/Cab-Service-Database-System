...
print("WELCOME TO QuiCab. WE HOPE TO PROVIDE YOU WITH THE BEST EXPERIENCE POSSIBLE.")               #INTRO
...
while True:
    if option==1:                                       #USER REGISTRATION
        ...
        print('''QuiCab was started in 2012 with the ambition of making every ride the best ever for the consumer.\n
              Our mission statement is 'To improve people's lives with the world's best transportation. '\n
              And one of QuiCab's “big picture visions” is to reinvent cities “around people instead of cars,\n
              and replace parking lots with green spaces and parks.”\n
              QuiCab is committed to effecting positive change for our cities by offsetting carbon emissions from all rides,\n
